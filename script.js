...
window.addEventListener('DOMContentLoaded', function() {
  ...
  const resumeUploadLabel = document.querySelector('.resume-upload-label');
  ...
  if(resumeUploadInput) {
    ...
    resumeUploadInput.addEventListener('change', function(e) {
      ...
      if(file) {
        ...
        resumeUploadLabel.style.display = 'none';
        resumeDisplay.style.display = 'block';

        // Store the file URL in session storage for persistence
        sessionStorage.setItem('resumeFileURL', fileURL);
      }
    });

    // Handle clear/remove resume
    if(resumeClearBtn) {
      resumeClearBtn.addEventListener('click', function() {
        ...
        // Hide display area and show upload area
        resumeDisplay.style.display = 'none';
        resumeUploadLabel.style.display = 'flex';
    ...
    // Restore resume on page load if it was previously uploaded in this session
    if(sessionStorage.getItem('resumeFileURL')) {
      resumeIframe.src = sessionStorage.getItem('resumeFileURL');
      resumeUploadLabel.style.display = 'none';
      resumeDisplay.style.display = 'block';
    }
  }
